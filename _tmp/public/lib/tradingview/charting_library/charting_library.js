! function(t, e) {
  ...
  function s() {
    return "1.14 (internal id e6c52313 @ 2019-06-14 13:13:35.217325)"
  }
  var r = function() {
    function t(t) {
    ...
    return t.prototype.onChartReady = function(t) {
      ...
      var i = this._iFrame;
      (this._options.autosize || this._options.fullscreen) && (i.style.width = "100%", this._options.fullscreen || (i.style.height = "100%")), window.addEventListener("resize", this._onWindowResize), this._onWindowResize(), this._innerWindowLoaded = new Promise(function(t) {
        var e = function() {
  ...
  window.TradingView = window.TradingView || {}, window.TradingView.version = s, t.version = s, t.widget = r, Object.defineProperty(t, "__esModule", {
    value: !0
  })
});
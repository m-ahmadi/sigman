...
import Worker from './combo.worker.js';

const inst = {};
export default Object.assign(inst, { init, create, inited: undefined });

let root, instruments, data, worker, ul;

function init() {
  instruments = tse.getInstruments();
  ...
  // new Worker('js/datable/combo.worker.js');
  worker = new Worker();

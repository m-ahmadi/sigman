...
const types = {
	...
	'68':  ['شاخص', 'اصلی'],
	'69':  ['شاخص', 'فرابورس'],
	'70':  ['اوراق مشاركت', 'صکوک اختصاصی 70'],
	'200': ['اوراق مشاركت', 'انرژی'],
	'207': ['اوراق مشاركت', 'ارز صادراتی'],
	...
	'306': ['اوراق مشاركت', 'آتیسی'],
	'307': ['سهام عادی', 'تسهیلات فرابورس'],
	'308': ['اوراق مشاركت', 'کالا'],
	'309': ['سهام عادی', 'پایه'],
	...
	'322': ['اختیار خ اخزا ( اسناد خزانه داری اسلامی )', '322'],
	'323': ['اختیارف اخزا ( اسناد خزانه داری اسلامی )', '323'],
	...
	'706': ['اوراق مشاركت', 'صکوک اختصاصی 706'],
	'801': ['سلف بورس انرژی', '801'],
	'802': ['سلف بورس انرژی', '802'],
	'803': ['سلف بورس انرژی', '803'],
	'804': ['سلف بورس انرژی', '804'],
	'901': ['انرژی', '901'],
	'902': ['انرژی', '902'],
...
async function test() {
	...
	const l2 = Object.keys(types).map((k,i) => ({id: l1.length+i+1, node: types[k][1], parent: l1.find(j=>j.node===types[k][0]).id}));
	dd = l1.concat(l2);
	dd = dd.filter(i => i.node);
	
	jd = dd.map(i => ({ id: ''+i.id, text: i.node, parent: ''+i.parent, state: {opened: true}, ...i.parent !== '#' && {icon: 'jstree-file'} }));
